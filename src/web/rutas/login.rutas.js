...
loginRutas.get('/login', (req, res) => {
    ...
    res.render('login/iniciar_sesion', { titulo: 'HOSKA - Inicio de sesión', error })
})
...
loginRutas.get('/solicitud', (req, res) => {
    res.render('login/solicitud_acceso', { titulo: 'HOSKA - Solicitud de acceso' })
})
...
loginRutas.get('/pendiente', (req, res) => {
    res.render('login/sala_espera', { titulo: 'HOSKA - Solicitud pendiente' })
})
